      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            '[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:[--drawer-content-width:24rem] data-[swipe-axis=y]:[--drawer-content-max-height:calc(100dvh-6rem)] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:100dvh] max-sm:data-[swipe-axis=x]:[--drawer-content-width:75%]',
            // Stack.
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex shrink-0 flex-col gap-1.5 p-4 pb-0 text-left group-data-[swipe-axis=y]/drawer-popup:max-md:gap-0.5 group-data-[swipe-axis=y]/drawer-popup:max-md:text-center',
        className,
      )}
      {...props}
    />
