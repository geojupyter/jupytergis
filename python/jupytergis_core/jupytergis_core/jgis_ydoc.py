...
class YJGIS(YBaseDoc):
    def __init__(self, *args, **kwargs):
        ...
        self._ydoc["storiesMap"] = self._ystoriesMap = Map()
    ...
    def get(self) -> str:
        ...
        stories_map = self._ystoriesMap.to_py()
    ...
    def set(self, value: str) -> None:
        ...
        with self._ydoc.transaction():
            ...
            self._ystoriesMap.clear()
            self._ystoriesMap.update(valueDict.get("storiesMap", {}))
    ...
    def observe(self, callback: Callable[[str, Any], None]):
        ...
        self._subscriptions[self._ystoriesMap] = self._ystoriesMap.observe_deep(
            partial(callback, "storiesMap")
        )
